...
<body class="body_relative">
	...
	<div class="mainfondiv2">
		...
		<div class="houses_header">
			<img class="img_v" src="/admin/img/houses_header_bg7.jpg" alt="" />
			<div class="houses_header_text1">Административная<br />панель управления<br />БАЗОЙ ПРАКИНГА</div>
			<div class="houses_header_text2" style="top: 62%;">Мини CRM система для управления базой паркинга<br />на сайте и внутри отдела продаж, мы поможем вам<br />делать это легко.</div>
		</div>
