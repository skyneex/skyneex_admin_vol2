...
<div class="vivod_kv_block">
	...
	$ft_put="../../kv".$Ndoma."/";
	$ddd=date('d'); $mmm=date('m'); $ggg=date('Y'); $dataNow=($ggg*372)+($mmm*31)+$ddd; if($kl_rk5!=""){$dataKV=($kl_rkk5[2]*372)+($kl_rkk5[1]*31)+$kl_rkk5[0]; if($dataNow>=$dataKV and $kl_rk5!="") $date_cvet="vivod_kv_block_item_bron_prosr";};
	?>
