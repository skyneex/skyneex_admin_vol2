...
$config['smtp_username'] = 'rezidentsia.maxim@yandex.ru';  //Смените на адрес своего почтового ящика.
$config['smtp_port'] = '465'; // Порт работы.
$config['smtp_host'] =  'ssl://smtp.yandex.ru';  //сервер для отправки почты
$config['smtp_password'] = '1986good';  //Измените пароль
$config['smtp_debug'] = true;  //Если Вы хотите видеть сообщения ошибок, укажите true вместо false
$config['smtp_charset'] = 'utf-8';	//кодировка сообщений. (windows-1251 или utf-8, итд)
if ($pochta=="" or $pochta=="Укажите e-mail") $config['smtp_from'] = 'siteXmail@yandex.ru'; else $config['smtp_from'] = $pochta;
//$config['smtp_from'] = 'МегаСервис'; //Ваше имя - или имя Вашего сайта. Будет показывать при прочтении в поле "От кого"
	
function smtpmail($to='user', $mail_to, $subject, $message, $headers='') {
	global $config;
...
smtpmail('user','jenya@skyneex.ru','Сообщение, админка, ЖК fffff',$pismo2);
smtpmail('user','art@skyneex.ru','Сообщение, админка, ЖК fffff',$pismo2);
