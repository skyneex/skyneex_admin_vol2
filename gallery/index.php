...
<body class="body_relative">
	...
	<div class="mainfondiv2">
		...
		<div class="houses_header">
			...
			<div class="houses_header_text1" style="top: 27%;">Административная<br />панель управления<br />БАЗОЙ галерей</div>
			<div class="houses_header_text2" style="top: 72%;">Мини CRM система для управления базой галерей<br />на сайте и внутри отдела продаж, мы поможем вам<br />делать это легко.</div>
		</div>
		
		<div class="add_art" onclick="artadd();">ДОБАВИТЬ ГАЛЕРЕЮ</div>
