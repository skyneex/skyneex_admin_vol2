...
<div class="form_main_block">
	<div class="form_main_block2">
		...
		<div class="form_main_text1">% хода строительства</div>
		<div class="p100" style="background: rgba(0,0,0,0.5); margin: 20px 0 0 0;"></div>

	<!-- ========================================================================================================================== -->
		
		<div class="form_conteiner" style="margin: 10px 0 0 0;">
			<input id="set1" class="input1" style="width: 729px;" onfocus="$('.forms_ico_F1').css('opacity','0'); $('.forms_ico_L1').css('display','block');" onblur="$('.forms_ico_F1').css('opacity','1'); $('.forms_ico_L1').css('display','none');" type="text" value="<?echo $si_hod;?>" placeholder="% хода строительства" />
...
set1=$('#set1').val();
$(".adm_div1").load("forma-opisanie5-save.php",{set1:set1},function(){$('.adm_zagr,.adm_div2_dop').css('display','none');});
};
</script>
