...
<div class="form_main_block">
	<div class="form_main_block2">
		...
		<div class="form_main_text1">Описание сайта</div>
		<div class="p100" style="background: rgba(0,0,0,0.5); margin: 20px 0 0 0;"></div>

	<!-- ========================================================================================================================== -->

		<div class="form_conteiner" style="margin: 10px 0 0 0;">
			<textarea id="set1" class="textarea1" style="width: 729px;" onfocus="$('.forms_ico_F2').css('opacity','0'); $('.forms_ico_L2').css('display','block');" onblur="$('.forms_ico_F2').css('opacity','1'); $('.forms_ico_L2').css('display','none');" type="text" placeholder="Описание сайта"><?echo $si_ops;?></textarea>
...
set1=$('#set1').val();
$(".adm_div1").load("forma-opisanie2-save.php",{set1:set1},function(){$('.adm_zagr,.adm_div2_dop').css('display','none');});
};
</script>
