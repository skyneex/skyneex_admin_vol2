...
<body class="body_relative">
	...
	<div class="mainfondiv2">
		...
		<div class="houses_header">
			<img class="img_v" src="/admin/img/houses_header_bg4.jpg" alt="" />
			<div class="houses_header_text1" style="top: 24%;">Административная<br />панель управления<br />БАЗОЙ новостей</div>
			<div class="houses_header_text2" style="top: 71%;">Мини CRM система для управления базой новостей<br />на сайте и внутри отдела продаж, мы поможем вам<br />делать это легко.</div>
		</div>
		
		<div class="add_art" onclick="artadd();">ДОБАВИТЬ НОВОСТЬ</div>
