...
<div class="vivod_kv_block">
	<?
	$sqll="select * from 10Articles where id!=1 and cat='building' and kod=$kod order by gg desc, mm desc, dd desc, id desc"; $sql=mysql_query($sqll);
	...
	<div class="vivod_kv_block_item">
		<p class="vivod_kv_block_item_p1" style="width: 64%;"><?echo $zag;?> | дом <?echo $hs_dom;?></p>
