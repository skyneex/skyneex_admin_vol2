...
<?if ($logg=="admin") {?>
<title>управление ходом строительства</title>
</head>
<body class="body_relative">
	...
	<div class="mainfondiv2">
		...
		<div class="houses_header">
			<img class="img_v" src="/admin/img/houses_header_bg3.jpg" alt="" />
			<div class="houses_header_text1" style="top: 27%;">Административная<br />панель управления<br />БАЗОЙ строительства</div>
			<div class="houses_header_text2" style="top: 72%;">Мини CRM система для управления базой строительства<br />на сайте и внутри отдела продаж, мы поможем вам<br />делать это легко.</div>
		</div>
		
		<div class="add_art" onclick="artadd();">ДОБАВИТЬ ЭТАП СТРОИТЕЛЬСТВА</div>
