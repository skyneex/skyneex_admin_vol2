...
<div class="form_main_block">
	<div class="form_main_block2" style="margin: 50px 0 100px 0;">
		...
		<div class="form_main_text1">Редактор хода строительства</div>
	...
	<!-- ========================================================================================================================== -->
		...
		hs_dom=$(this).data("valik"); $('.form_radio_ico1').css('opacity','1'); $('.form_radio_ico2').css('display','none'); $(this).find('.form_radio_ico1').css('opacity','0'); $(this).find('.form_radio_ico2').css('display','block');
		});
		</script>
		<div class="p100"></div>
...
$(".artfoto").load("artfoto.php",{idnn:<?echo $id;?>}); hs_dom='<?echo $hs_dom;?>';
...
$(".adm_div1").load("artsave.php",{polik1:polik1,polik2:polik2,polik3:polik3,zag:zag,txt:txt,hs_dom:hs_dom,idd:'<?echo $id;?>'},function(){$('.vivod_kv').load('artvew.php',function(){$('.adm_div2,.adm_zagr').css('display','none'); $('body').css('overflow','auto');})});
};
</script>
